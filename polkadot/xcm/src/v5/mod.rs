...
parameter_types! {
	pub MaxXcqSize: u32 = 2 * 1024 * 1024;
	pub MaxXcqResult: u32 = 1024;
}
...
pub enum Response {
	...
	XcqResult(BoundedVec<u8, MaxXcqResult>),
}
...
pub enum Instruction<Call> {
	...
	///
	/// Errors: *Fallible*.
	ReportQuery { query: BoundedVec<u8, MaxXcqSize>, max_weight: Weight, info: QueryResponseInfo },
}
